/**
 * This script contains all jqPlot functions to work with Flatnuke.
 * Due to the prefix none_ in the name, it will not be authomatically
 * loaded by Flatnuke engine, but ou have to explicitly include it
 * in your pages.
 *
